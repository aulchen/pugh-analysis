...
Prove the following.
\subsubsection*{Part a}
If $U$ is an open subset of $\mathbb{R}$ then it consists of countably many disjoint intervals $U = \cup U_i$. (Unbounded intervals $(-\infty, b)$, $(a, \infty)$, and $(-\infty, \infty)$ are allowed).

First, we will show that an open set consists of the (perhaps uncountable) disjoint union of open intervals. Let $U$ be open. Then for all $u \in U$, there exists an $r_u > 0$ such that the open ball $(u-r_u, u+r_u) \subset U$.
