...
False. Consider $\R^2$, the open rectangles $A = (-1, 1) \times (2, 0)$, $B = (-1/2, -1/2) \times (1/2, 1/2)$, and let $E = A \cup B$. $E$ is clearly open and bounded, and a bit of thought will show that $A$ is starlike with $p_0 = (0, 0)$ as a center.
