...
\begin{theorem}
If $A$ is an open subset of $\mathbb{R}$, then it consists of countably many disjoint intervals $A = \sqcup A_i$.

\begin{proof}
By Lemma \ref{OpenSetsAreUnionsOfOpenIntervals} and Corollary\ref{BoundedIntervalsBecomeDisjoint}, there exists a collection of disjoint (possibly unbounded) open intervals $A_i$ such that $A = \sqcup A_i$.
\end{proof}
\end{theorem}
