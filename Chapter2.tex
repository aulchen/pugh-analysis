...
Because $A$ is not equal to $\mathbb{R}$, it has an upper or lower bound. Suppose $A$ has an upper bound. Then $B_a$ and $C_a$ have right endpoints $b$ and $c$. We claim that $b = c$. If $b < c$, then 
